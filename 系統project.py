...
if ProgramList[0][2] == "START":
    ...
    while ProgramList[focusCount][2] != "END":
        if ProgramList[focusCount][0] != "CMDx":
            if function_db.op_table_get_op_code(ProgramList[focusCount][2]) != 0 or ProgramList[focusCount][2] == "BASE" \
                    or ProgramList[focusCount][2] == "BYTE" or ProgramList[focusCount][2] == "RESW" \
                    or ProgramList[focusCount][2] == "RESB":
                ProgramList[focusCount][4] = function_db.op_table_get_op_code(ProgramList[focusCount][2])
                if ProgramList[focusCount][3]:
                    if ProgramList[focusCount][2] == "BASE":
                    ...
                    if ProgramList[focusCount][3][0] == "#" and function_db.symbol_table_get(
                        ...
                        if function_db.symbol_table_get(ProgramList[focusCount][3]) != -1:
                            ...
                            if -2048 < int(displace, 16) < 2047:
                                ...
                                ProgramList[focusCount][4] = ProgramList[focusCount][4][2:] + "4"
                                displace = function_db.hex_sub(function_db.symbol_table_get(ProgramList[focusCount][3]), B)
                            ProgramList[focusCount][4] += displace[2:].zfill(3)
                            ProgramList[focusCount][4] = ProgramList[focusCount][4].zfill(6)
            ...
            elif ProgramList[focusCount][2][0] == "+" and function_db.op_table_get_op_code(
                    ProgramList[focusCount][2][1:]):
                ProgramList[focusCount][4] = function_db.op_table_get_op_code(ProgramList[focusCount][2][1:])
            else:
...
ProgramList = function_db.adjust(ProgramList)
